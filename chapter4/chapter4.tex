...
% Is the radio still in red contours? 
		...
		\begin{threeparttable}
			...
			\begin{tabular}{l r r p{0.7cm} l l l l}
				...
				\hline 
				ESO 443-G024 & 0.048 & 0.33 & 55.2 	& SR & NRR & KDC & c \\
				IC 1459 	& 0.125 & 0.24 & 87.9	& SR & NRR & KDC & c \\
				IC 1531 	& 0.101 & 0.01 & 64.4 	& FR & NRR & LV & a \\
				IC 4296		& 0.034 & 0.03 & 83.2 	& SR & RR & -- & e \\
				NGC 612 	& 0.655 & 0.36 & \leavevmode\phantom{0}7.3 	& FR & RR & -- & e \\
				NGC 1316 	& 0.100 & 0.39 & 72.1 	& FR & NRR & -- & f \\
				NGC 1399 	& 0.090 & 0.12 & 27.2 	& SR & NRR & LV & a \\
				NGC 3100 	& 0.354 & 0.24 & 19.8 	& FR & RR & -- & e \\
				NGC 3557 	& 0.312 & 0.21 & \leavevmode\phantom{0}7.6 	& FR & RR & -- & e\\
				NGC 7075 	& 0.068 & 0.25 & 20.0 	& SR & NRR & -- & b \\
				PKS 718-34  & 0.220 & 0.38 & 57.7 	& FR & NRR & KDC$^\text{a}$ & b\\
				\hline
				\hline
			\end{tabular}
			\begin{tablenotes}
...
% Comparisons. ^^^^
		...
		\subsection{Fast/Slow Rotator Classification}
			...
			\begin{figure}
				...
				\caption[Mass matching global kinematics]{Upper panel: mass distribution of the combined Atlas$^\text{3D}$ and MASSIVE surveys (black) and of our Southern sample (red). Lower panel: fraction of slow rotators within each mass bin. The labels list the number of slow rotators and total number of galaxies in each bin.}
