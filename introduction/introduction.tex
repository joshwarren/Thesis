...
% ^^^^^^^^^^^^^ not corrected above paragraph yet ^^^^^^^^^^^
	...
	\begin{figure}
		...
		\caption[The Hubble tuning-fork]{Hubble diagram (or tuning fork), showing the different morphology classifications of galaxies. 
		% Add more of a basic desciption of the morphological types
		Figure courtesy of http://spacetelescope.org}
		\label{fig:Hubble}
	\end{figure}
	...
	\begin{figure}
		...
		% \includegraphics[width=\textwidth]{introduction/colourRedCorr_mass.jpeg}
		% \caption[colour--Mass diagram]{A reddening-corrected colour--mass diagram showing the distribution of ETGs and LTGs on the colour--mass plane with the red sequence, blue cloud and dividing green valley labeled. Figure courtesy of \citet{Schawinski2014}}
		\includegraphics[width=0.5\textwidth]{introduction/sfMass.png}
		\caption[Star-formation rate--galaxy mass diagram]{The dichotomy in the star-formation rate--mass plane for the MPA-JHU sample galaxies \citep{Kauffmann2003, Brinchmann2003, Salim2007}.}
	...
	\begin{figure}
		\centering
		\includegraphics[width=.5\textwidth]{introduction/agnFeedback.png}
	...
	\begin{figure}
		\centering
		\includegraphics[width=.4\textwidth]{introduction/unifiedAGN.jpeg}
...
% star formation also gives strong radio emission - all galaxies are visable! Correct below:
	...
	This thesis will compare and contrast the stellar and ionised gas properties of RGs and radio-quiet ETGs. 
	% Exploring the nature and origin of the fuel in RGs, as well as the mechanism of accretion and effect of the resulting AGN feedback forms the basis of this thesis. 
	The rest of this chapter will thus cover the background required to study the RG population. Firstly, since RGs are primarily found in ETGs, the current understanding of ETGs will be reviewed. This is mostly a summary of the recent integral field spectroscopy (IFS) surveys including Atlas$^\text{3D}$, MaNGA, MASSIVE, SAMI and Califa, and can be considered as setting out of the control sample for later investigations. Secondly, a more detailed summary of the current state of our understanding of AGN will be presented, including RGs. Finally, the selection criteria of the sample used throughout this thesis will be described.
...
\section{Southern Sample}
	...
	\begin{threeparttable}
		...
		\begin{tabular}{l l l l}
			...
			IC 1459 	& -25.27 & 23.0 				& $\leavevmode\phantom{-}0.25 \pm 0.06^\text{a}$ 	\\
		...
		\end{tabular}
		\begin{tablenotes}
		\item $^\text{a}$ IC 1459 shows a turn over in its spectral energy distribution at $\approx 1 \, \text{GHz}$ i.e. it is a gigahertz-peaked spectrum (GPS) galaxy. This means the spectral index is very sensitive to the frequency range over which is measured.
