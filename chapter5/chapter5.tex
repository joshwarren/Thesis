...
\section{Ionization Sources}
	...
	\subsection{Extrapolating VIMOS Data}
		\label{subsec:Ndec}
		As stated above, most of the diagnostic plots for identifying the dominant source of ionization in a given galaxy require measurements of emissions line that lie outside of the spectral range of VIMOS. As such, to be able to classify our VIMOS data in this way we transform the classification boundary lines to plots involving the same atoms, but different ionization species e.g.\ 
		% Is species the right word?
		transform from the classic BPT [\ion{N}{ii}]/H$\alpha$ versus [\ion{O}{iii}]/H$\beta$ to [\ion{N}{i}]/H$\beta$ versus [\ion{O}{iii}]/H$\beta$ diagnostic plot (hereafter the SAURON diagnostic plot). 

		\begin{figure}
			\centering
			\includegraphics[width=0.7\textwidth]{chapter5/ratio_fit.png}
			\caption[\brackets{\ion{N}{ii}}/H$\alpha$ vs \brackets{\ion{N}{i}}/H$\beta$]{Comparing [\ion{N}{ii}]/H$\alpha$ and [\ion{N}{i}]/H$\beta$ line ratios for the galaxies IC 1459 and NGC 1316, used to transform the classification boundaries of diagnostics involving the H$\alpha$ equivalent width to those involving H$\beta$.} 
		...
		\begin{figure}
			...
			\caption[Comparing H$\alpha$ and H$\beta$ equivalent widths]{Comparing H$\alpha$ and H$\beta$ equivalent widths for the galaxies IC 1459 and NGC 1316. The best-fit relationship is used to transform the classification boundaries of the classic [\ion{N}{ii}] BPT plot to the SARUON diagnostic plot.} 
			\label{fig:ratio_relation}
		\end{figure}
