...
\begin{threeparttable}
	...
	\begin{tabular}{l c c c c}
		...
		\hline
		ESO 443-G024 & $5.02 \pm 0.01$ 	& --  		& -- & Passive \\
		...
		NGC 3100 	& $5.26 \pm 0.01$	& -- 		& -- & Seyfert 2 \\
		NGC 3557 	& $4.61 \pm 0.02$ 	& -- 		& -- & LINER/Retired \\
...
\section{Ionized Gas Distribution}
	...
	\subsection{Gas Masses}
		...
		Our calculated gas masses are given Table \ref{tab:gasMass}. 
...
\section{Ionization Sources}
	...
	\subsection{Extrapolating VIMOS Data}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\textwidth]{chapter5/ratio_fit.png}
			\caption[\brackets{\ion{N}{ii}}/H$\alpha$ vs \brackets{\ion{N}{i}}/H$\beta$]{Upper panel: [\ion{N}{ii}]/H$\alpha$ vs [\ion{N}{i}]/H$\beta$ line ratios for the galaxies IC 1459 and NGC 1316, used to transform the classification boundaries of the classic [\ion{N}{ii}] BPT plot to the SARUON diagnostic plot. Lower panel: Residuals = ([\ion{N}{ii}]/H$\alpha$ - best-fit)/[\ion{N}{i}]/H$\beta$.} 
			\label{fig:ratio_relation}
		\end{figure}

		\begin{figure}
			\centering
			\includegraphics[width=0.7\textwidth]{chapter5/EQw_fit.png}
			\caption[Comparing H$\alpha$ and H$\beta$ equivalent widths]{Upper panel: H$\alpha$ vs H$\beta$ equivalent widths for the galaxies IC 1459 and NGC 1316 used to transform the classification boundaries of diagnostics involving the H$\alpha$ equivalent width to those involving H$\beta$. Lower panel: Residuals = (EW(H$\alpha$) - best-fit)/EW(H$\beta$)} 
...
% 		As can be seen in the figure, there two galaxies have quite different gradients. We require a single function to be able to use [\ion{N}{i}] as a proxy for [\ion{N}{ii}] for our VIMOS data. We thus fit each galaxy independently and use the mean gradient, neglecting the intercept. We find a mean gradient of $12.23 \pm 0.14$.
...
% 		\end{figure}
	...
	\subsection{BPT Diagnostics}
		...
		\begin{figure}
			...
			\caption[NGC 3100 \brackets{\ion{N}{i}}/H$\beta$ line ratio map]{The [\ion{N}{i}]/H$\beta$ line ratio map of NGC 3100, showing the hardest ionization field is in gap in the CO ring (cyan contours), spatially coincident with the radio jet (green contours). Surface brightness contours are in black.}
